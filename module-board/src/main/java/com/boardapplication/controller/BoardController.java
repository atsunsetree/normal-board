...
public class BoardController {
    ...
    public String listByRole(@PathVariable("role") String role, Model model, @PageableDefault(page = 0, size = 6, sort = "id", direction = Sort.Direction.DESC) Pageable pageable) {
